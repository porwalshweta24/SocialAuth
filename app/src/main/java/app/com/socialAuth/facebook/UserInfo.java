...
public class UserInfo extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.fb_user_info);
	...
	private void displayUserInfo() {
		HashMap<String, String> userHashmap = (HashMap<String, String>) getIntent()
				.getSerializableExtra(FacebookActivity.USER_MAP);

		userId = userHashmap.get(FacebookActivity.USER_ID);

		String userName = userHashmap.get(FacebookActivity.USER_NAME);
		String firstName = userHashmap.get(FacebookActivity.FIRST_NAME);
		String lastName = userHashmap.get(FacebookActivity.LAST_NAME);
		String birthday = userHashmap.get(FacebookActivity.BIRTHDAY);
		String email = userHashmap.get(FacebookActivity.EMAIL_ID);
