package app.com.socialAuth.insta.Instagram;
...
import app.com.socialAuth.insta.InstaLoads.ImageLoader;
...
public class InstaActivity extends Activity implements OnClickListener {
	...
	private Handler handler = new Handler(new Callback() {
		...
		public boolean handleMessage(Message msg) {
			if (msg.what == InstagramApp.WHAT_FINALIZE) {
				...
				Toast.makeText(InstaActivity.this, "Check your network.",
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.ig__activity);
		...
		mApp.setListener(new InstagramApp.OAuthAuthenticationListener() {
			...
			public void onFail(String error) {
				Toast.makeText(InstaActivity.this, error, Toast.LENGTH_SHORT)
						.show();
			}
		});
		setWidgetReference();
	...
	public void onClick(View v) {
		if (v == btnConnect) {
			...
			startActivity(new Intent(InstaActivity.this, AllMediaFiles.class)
			...
			startActivity(new Intent(InstaActivity.this, Relationship.class)
	...
	private void displayInfoDialogView() {
		...
		View view = inflater.inflate(R.layout.ig_profile_view, null);
		...
		new ImageLoader(InstaActivity.this).DisplayImage(
